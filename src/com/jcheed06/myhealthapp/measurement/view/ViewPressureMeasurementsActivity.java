...
public class ViewPressureMeasurementsActivity extends Activity {
	...
	private void createOnItemClickListener() {
		pressureMeasurementsList.setOnItemClickListener(new OnItemClickListener() {
		...
		new AlertDialog.Builder(ViewPressureMeasurementsActivity.this).setMessage(
						...
						new DialogInterface.OnClickListener() {
							...
							public void onClick(DialogInterface dialog,	int which) {
								Measurement measurement = pressureListAdapter.getItem(position);
								...
								try {
									if (deletemeasurement.get()) {
										pressureListAdapter.remove(measurement);
									} else {
										Toast.makeText(
												getBaseContext(),
